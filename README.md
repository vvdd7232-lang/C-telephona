...
> (клиент, библиотеки, ресурсы, natives, загрузчик Fabric/Quilt; авто-Java).
...
- 🚀 **«Запустить»** — старт Minecraft (офлайн, singleplayer); если Java не
  найдена — автоматически скачивается и распаковывается Temurin JRE 17
...
- [x] Запуск игры (офлайн) + авто-скачивание Java (Temurin JRE 17)
- [ ] Forge / NeoForge
